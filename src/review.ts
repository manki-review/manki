 ...
 *   3. otherwise (only suggestions/nitpicks / previously-dismissed warnings / empty) → COMMENT / only_nit_or_suggestion
 *
 * Empty `findings` yields APPROVE / only_nit_or_suggestion so callers can still
...
export function determineVerdict(
  ...
  return { verdict, verdictReason: 'only_nit_or_suggestion' };
}
