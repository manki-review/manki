...
declare function runFullReview(owner: string, repo: string, prNumber: number, commitSha: string, baseRef: string, prContext?: PrContext, prAuthorLogin?: string, forceReview?: boolean): Promise<void>;
