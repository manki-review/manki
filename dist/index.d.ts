...
declare function handleCommentTrigger(forceReview?: boolean, skipCap?: boolean): Promise<void>;
declare function runFullReview(owner: string, repo: string, prNumber: number, commitSha: string, baseRef: string, prContext?: PrContext, prAuthorLogin?: string, forceReview?: boolean, skipCap?: boolean): Promise<void>;
