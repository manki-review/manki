...
export declare function migrateLegacyPrType(value: string): string;
...
export declare const RESOLVED_THREAD_SUPPRESSED_TAG: "suppressed-by-resolved-thread";
 ...
 */
export declare const VALID_PR_TYPE_VALUES: readonly ["build", "chore", "ci", "docs", "feat", "fix", "perf", "refactor", "revert", "style", "test"];
export type ValidPrType = typeof VALID_PR_TYPE_VALUES[number];
export declare const VALID_PR_TYPES: Set<string>;
 ...
 */
export declare function roundContextToFlatAliases(ctx: RoundContext): RoundContextFlatAliases;
