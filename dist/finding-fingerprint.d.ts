 ...
 */
export declare function indexThreadEvaluations(evaluations: ThreadEvaluation[] | undefined): Map<string, ThreadEvaluation>;
/**
 ...
 * as still unresolved).
 */
export declare function isPriorAddressedByJudge(prior: FindingFingerprintEntry, threadEvaluationsByThreadId: Map<string, ThreadEvaluation>): boolean;
